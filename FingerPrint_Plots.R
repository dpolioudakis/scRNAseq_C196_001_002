...
# Fluidigm LT human VZ and CP experiment
################################################################################
...
ggplot(ggDF, aes(x = Var2, y = Var1, fill = value)) +
  ...
  ggtitle(paste0(graphCodeTitle
                 , "\nVariants called for each Cell: Fluidigm LT, Human VZ and CP"
                 , "\n"))
ggsave(paste0(outGraph, "Heatmap.pdf"))
...
ggplot(ggDF, aes(x = Count)) +
  ...
  scale_x_continuous(breaks = 0:max(ggDF$Count)) +
